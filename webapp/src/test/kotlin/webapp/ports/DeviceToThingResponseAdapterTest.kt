...
class DeviceToThingResponseAdapterTest {
    ...
    @Test
    fun `adapt correctly`() {
        val thingId1 = UUID.fromString("c9ebf5e1-e449-4af5-ac6b-99d40ac6256b").asThingId()
        val deviceId2 = UUID.fromString("7832718b-efc4-45cc-a166-c97ffce7761d").asDeviceId()
        val thingId2 = UUID.fromString("db1b2a4c-2f60-4def-9a6c-217128245b8d").asThingId()
        val deviceId1 = UUID.fromString("10152e1b-d6d4-4536-8679-52a0446dc753").asDeviceId()
